package org.apache.jsp.WEB_002dINF.endereco;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class modal_002dendereco_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"modal fade\" id=\"modal-endereco\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t<form id=\"form-endereco\" method=\"post\">\r\n");
      out.write("\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\"\r\n");
      out.write("\t\t\t\t\taria-label=\"Close\">\r\n");
      out.write("\t\t\t\t\t<span aria-hidden=\"true\">&times;</span>\r\n");
      out.write("\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t<h4 class=\"modal-title\">Informações do endereço</h4>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t<label for=\"logradouro\">Logradouro</label>\r\n");
      out.write("\t\t\t\t<input id=\"logradouro\" name=\"logradouro\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<label for=\"cep\">Cep</label>\r\n");
      out.write("\t\t\t\t<input id=\"cep\" name=\"cep\" class=\"form-control\"> \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<label for=\"numero\">Numero</label>\r\n");
      out.write("\t\t\t\t<input id=\"numero\" name=\"numero\" class=\"form-control\"> \r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<label for=\"bairro\">Bairro</label>\r\n");
      out.write("\t\t\t\t<input id=\"bairro\" name=\"bairro\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<label for=\"cidade\">Cidade</label>\r\n");
      out.write("\t\t\t\t<input id=\"cidade\" name=\"cidade\" class=\"form-control\"> \r\n");
      out.write("\t\t\t\t\r\n");
